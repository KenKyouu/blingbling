    ...
    <div id="app">
        ...
        <div class="over">
            <div class="box">
                ...
                <p>恭喜！獲得 $<span class="end_winNum">0</span> 購物金</p>
                <button class="okgo">
                    <p>Bling！購物去</p>
                </button>
        ...
        <div id="animation_container" style="background-color:rgba(255, 255, 255, 1.00); width:1920px; height:1000px">
            <canvas id="canvas" width="1920" height="1050" style="position: absolute; display: block; background-color:rgba(255, 255, 255, 1.00);"></canvas>
