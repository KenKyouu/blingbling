                        ...
                        <div class="left col-lg-3 col-xl-3">
                            <div class="myName">
                                <div class="photo">
                                    ...
                                    <div class="photoedit">
                                        <svg width="8" height="8" viewBox="0 0 25 25" fill="none"
                                    ...
                                    <li class="btn col-4 col-md-2 col-lg-12"><a href="#">
                                        <div class="btnsvg">
                                            <svg width="14" height="14" viewBox="0 0 25 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M12.4721 12.5341C15.935 12.5341 18.7422 9.72825 18.7422 6.26705C18.7422 2.80585 15.935 0 12.4721 0C9.00915 0 6.2019 2.80585 6.2019 6.26705C6.2019 9.72825 9.00915 12.5341 12.4721 12.5341Z"
                                                    fill="#4C4948" />
                                                <path
                                                    d="M24.9416 25.0001C24.9416 18.1164 19.3591 12.5342 12.4695 12.5342C5.57993 12.5342 0 18.1164 0 25.0001H24.9416Z"
                                                    fill="#4C4948" />
                                            </svg>
                                        </div>
                                        <div class="btnP">
                                        ...
                                        <div class="btnsvg">
                                            <svg width="15" height="13" viewBox="0 0 26 23" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    fill="#4C4948" stroke="#4C4948" stroke-miterlimit="10" />
                                                <path
                                        ...
                                        <div class="btnsvg">
                                            <svg width="15" height="10.5" viewBox="0 0 27 20" fill="none"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M24.8831 12.0754C24.0271 12.9183 22.4636 14.3182 20.464 15.505C18.4612 16.6938 16.0535 17.6494 13.5 17.6494C10.9465 17.6494 8.53878 16.6938 6.53596 15.505C4.5363 14.3181 2.97275 12.9181 2.11677 12.0753C1.96829 11.9283 1.88796 11.7357 1.88796 11.529C1.88796 11.3223 1.96829 11.1297 2.11677 10.9827C2.97275 10.1398 4.5363 8.73984 6.53596 7.55295C8.53878 6.36419 10.9465 5.40852 13.5 5.40852C16.0535 5.40852 18.4612 6.36419 20.464 7.55295C22.4636 8.73978 24.0271 10.1397 24.8831 10.9825C25.0317 11.1296 25.112 11.3222 25.112 11.529C25.112 11.7357 25.0317 11.9284 24.8831 12.0754ZM5.84959 6.3479C7.98602 5.08357 10.6318 4.02075 13.5 4.02075C16.3695 4.02075 19.0153 5.08355 21.1514 6.34792C23.29 7.61372 24.9496 9.10034 25.8566 9.99365C26.2702 10.4004 26.5 10.9476 26.5 11.529C26.5 12.1104 26.2702 12.6576 25.8566 13.0643C24.9495 13.9577 23.2893 15.4443 21.1504 16.7101C19.014 17.9744 16.3682 19.0372 13.5 19.0372C10.6318 19.0372 7.98602 17.9744 5.84959 16.7101C3.71047 15.4441 2.05009 13.9573 1.14313 13.064C0.729663 12.6573 0.5 12.1102 0.5 11.529C0.5 10.9478 0.729663 10.4007 1.14313 9.99396M5.84959 6.3479C3.71059 7.61375 2.05028 9.10045 1.14329 9.9938L5.84959 6.3479Z"
                                                    fill="#4C4948" />
                                                <path
                                                    d="M13.5001 18.3435C17.2654 18.3435 20.3178 15.2927 20.3178 11.5292C20.3178 7.76573 17.2654 4.71484 13.5001 4.71484C9.73477 4.71484 6.68237 7.76573 6.68237 11.5292C6.68237 15.2927 9.73477 18.3435 13.5001 18.3435Z"
                                                    fill="#4C4948" />
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M13.5001 5.21484C10.0107 5.21484 7.18237 8.04211 7.18237 11.5292C7.18237 15.0163 10.0107 17.8435 13.5001 17.8435C16.9895 17.8435 19.8178 15.0163 19.8178 11.5292C19.8178 8.04211 16.9895 5.21484 13.5001 5.21484ZM6.18237 11.5292C6.18237 7.48936 9.45886 4.21484 13.5001 4.21484C17.5413 4.21484 20.8178 7.48936 20.8178 11.5292C20.8178 15.569 17.5413 18.8435 13.5001 18.8435C9.45886 18.8435 6.18237 15.569 6.18237 11.5292Z"
                                                    fill="#4C4948" />
                                                <path d="M13.6939 1H13.3059V4.7148H13.6939V1Z" fill="#4C4948" />
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M12.8059 0.5H14.1939V5.2148H12.8059V0.5Z" fill="#4C4948" />
                                                <path
                                                    d="M8.80521 1.66793L8.46924 1.86182L10.3276 5.07883L10.6635 4.88495L8.80521 1.66793Z"
                                                    fill="#4C4948" />
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M7.78613 1.67871L8.98821 0.985013L11.3467 5.06792L10.1446 5.76162L7.78613 1.67871Z"
                                                    fill="#4C4948" />
                                                <path
                                                    d="M18.1961 1.67239L16.3374 4.8894L16.6734 5.08333L18.5321 1.86631L18.1961 1.67239Z"
                                                    fill="#4C4948" />
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M15.6543 5.07251L18.0133 0.989601L19.2154 1.68344L16.8564 5.76635L15.6543 5.07251Z"
                                                    fill="#4C4948" />
                                            </svg>
                                        </div>
                                        <div class="btnP">
                                    ...
                                    <li class="btn col-4 col-md-2 col-lg-12"><a href="#">
                                        <div class="btnsvg">
                                            <svg width="13" height="17" viewBox="0 0 20 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M16.5343 10.434V13.9637L18.9979 20.9875C19.1631 21.4551 18.8148 21.9455 18.319 21.9455H12.5757C12.5757 23.6328 11.2079 25 9.51971 25C7.83154 25 6.46372 23.6328 6.46372 21.9455H0.720383C0.22461 21.9455 -0.123701 21.4551 0.041556 20.9875L2.51025 13.9637V10.434C2.51699 7.2305 4.67462 4.5327 7.61588 3.70372V1.90394C7.61588 0.852424 8.4683 0 9.51982 0C9.52032 0 9.52083 1.95699e-07 9.52133 5.87027e-07C9.52164 1.95715e-07 9.52194 0 9.52225 0C9.52363 0 9.52501 3.97422e-06 9.52639 1.19119e-05C10.5749 0.00355513 11.4238 0.854616 11.4238 1.90394V3.70147C14.3691 4.52732 16.5275 7.22849 16.5343 10.434Z"
                                                    fill="#4C4948" />
                                            </svg>
                                        </div>
                                        <div class="btnP">
