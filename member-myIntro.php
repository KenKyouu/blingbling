                ...
                <div class="col">
                        ...
                        <div class="memberbutton">
                            <ul class="memberbutton">
                                ...
                                <li class="btn col-4 col-md-2 col-lg-12"><a href="#">
                                        <div class="btnsvg">
                                            <svg width="15" height="13" viewBox="0 0 26 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="whiteBg col-lg-9 col-xl-9">
                                    ...
                                    <div class="diamondicon">
                                        <svg width="15" height="13" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_388_1010)">
                                                <path d="M9.589 0H4.70107L0 5.33834L5.73767 6.34208L9.589 0Z" fill="#e1a77e" />
                                                <path d="M0.186768 6.27686L10.8364 20.3019L5.48743 7.20393L0.186768 6.27686Z" fill="#e1a77e" />
                                                <path d="M12.4821 6.3788H12.5001H12.5183H18.1957L14.3233 0H12.5183H12.4821H10.6771L6.80469 6.3788H12.4821Z" fill="#e1a77e" />
                                                <path d="M12.5 7.26904H6.52734L12.5423 21.9999L12.8284 21.3081L18.4759 7.26904H12.5Z" fill="#e1a77e" />
                                                <path d="M14.3022 20.1175L24.8132 6.27686L19.5125 7.20393L14.3022 20.1175Z" fill="#e1a77e" />
                                                <path d="M15.4109 0L19.2622 6.34208L24.9999 5.33834L20.2988 0H15.4109Z" fill="#e1a77e" />
                                            </g>
                                            <defs>
                                        ...
                                        <svg width="15" height="13" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_388_1010)">
                                                <path d="M9.589 0H4.70107L0 5.33834L5.73767 6.34208L9.589 0Z" fill="#c2c2c2" />
                                                <path d="M0.186768 6.27686L10.8364 20.3019L5.48743 7.20393L0.186768 6.27686Z" fill="#c2c2c2" />
                                                <path d="M12.4821 6.3788H12.5001H12.5183H18.1957L14.3233 0H12.5183H12.4821H10.6771L6.80469 6.3788H12.4821Z" fill="#c2c2c2" />
                                                <path d="M12.5 7.26904H6.52734L12.5423 21.9999L12.8284 21.3081L18.4759 7.26904H12.5Z" fill="#c2c2c2" />
                                                <path d="M14.3022 20.1175L24.8132 6.27686L19.5125 7.20393L14.3022 20.1175Z" fill="#c2c2c2" />
                                                <path d="M15.4109 0L19.2622 6.34208L24.9999 5.33834L20.2988 0H15.4109Z" fill="#c2c2c2" />
                                            </g>
                                            <defs>
                                                <clipPath id="clip0_388_1010">
                                                    <rect width="25" height="22" fill="white" />
                                        ...
                                        <svg width="15" height="13" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg" opacity="30%">
                                            <g clip-path="url(#clip0_388_1010)">
                                                ...
                                                <path d="M12.4821 6.3788H12.5001H12.5183H18.1957L14.3233 0H12.5183H12.4821H10.6771L6.80469 6.3788H12.4821Z" fill="#ffcd51" />
                                                <path d="M12.5 7.26904H6.52734L12.5423 21.9999L12.8284 21.3081L18.4759 7.26904H12.5Z" fill="#ffcd51" />
                                                <path d="M14.3022 20.1175L24.8132 6.27686L19.5125 7.20393L14.3022 20.1175Z" fill="#ffcd51" />
                                                <path d="M15.4109 0L19.2622 6.34208L24.9999 5.33834L20.2988 0H15.4109Z" fill="#ffcd51" />
                                            </g>
                                            <defs>
                                                <clipPath id="clip0_388_1010">
                                                    <rect width="25" height="22" fill="white" />
                            ...
                            <div class="myIntro">
                                <div class="userName">
                                    ...
                                    <div class="myIntro-info">
                                        <p class="myIntro-info"><?= $member[0]['name'] ?></p>
                                    </div>
                                </div>
                                <div class="gender">
                                    <div class="myIntro-title">
                                ...
                                <div class="birthday">
                                    ...
                                    <div class="myIntro-info">
                                        <p class="myIntro-info"><?= $member[0]['birthday'] ?></p>
                                    </div>
                                </div>
                                <div class="email">
                                    <div class="myIntro-title">
                                ...
                                <div class="phone">
                                    ...
                                    <div class="myIntro-info">
                                        <p class="myIntro-info"><?= $member[0]['mobile'] ?></p>
                                    </div>
                                </div>
                                <div class="address">
                                    <div class="myIntro-title">
                        ...
                        <button type="button" class="btn editMyInfo" data-toggle="modal" data-target="#exampleModalCenter">
                            <p class="edit">編輯資訊</p>
                            <svg width="17" height="18" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M22.3139 10.2864L14.7085 2.68474L17.1825 0.212005C17.4653 -0.0706682 17.9213 -0.0706682 18.2042 0.212005L24.7878 6.79241C25.0706 7.07509 25.0706 7.53093 24.7878 7.8136L22.3139 10.2864Z" fill="#000000" />
                                <path d="M21.1211 11.4791L13.4751 3.83691L2.32505 14.9815L9.971 22.6236L21.1211 11.4791Z" fill="#000000" />
                                <path d="M4.9528 19.9966L8.77459 23.8165L4.34386 24.4226L0.580677 24.937C0.244359 24.9829 -0.0410016 24.6976 0.00485987 24.3615L0.519529 20.6002L1.12592 16.1716L4.9528 19.9966Z" fill="#000000" />
                            </svg>
                        </button>
                        ...
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" name="editInfo" onsubmit="checkInfo(); return false;" novalidate>
                                            ...
                                            <div class="my-details">
                                                <div class="detail">
                                                    ...
                                                    <div class="detail-input">
                                                        <input type="password" name="infopassword" id="password" minlength="8" maxlength="12" placeholder="請設定8~12位數密碼(可用英文大小寫字母、數字)" required>
                                                    </div>
                                                </div>
                                                <div class="detail">
                                                    <div class="detail-text">
                                                    ...
                                                    <div class="detail-input">
                                                        <input type="password" name="infoconfirmPassword" id="confirmPassword" minlength="8" maxlength="12" placeholder="請再次填入密碼" required>
                                                    </div>
                                                </div>
                                                <div class="detail">
                                                    <div class="detail-text">
                                                ...
                                                <div class="detail">
                                                    ...
                                                    <div class="detail-input">
                                                        <input type="text" name="infoyear" placeholder="YYYY" class="birthmd" required>
                                                ...
                                                <div class="detail">
                                                    ...
                                                    <div class="detail-input">
                                                        <input type="text" name="infomobile" id="phone" placeholder="您的聯絡電話" required>
                                                    </div>
                                                </div>
                                                <div class="detail">
                                                    <div class="detail-text">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn true">儲存</button>
