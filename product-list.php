            ...
            <div class="color-filter-pc">
                ...
                <div class="color">
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="black-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="white-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="gray-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="brown-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="rice-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="green-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="blue-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="purple-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="yellow-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="pink-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="red-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="orange-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="silver-pc">
                    ...
                    <div class="color-content">
                        <input type="checkbox" name="color-pc" id="gold-pc">
