...
<link rel="stylesheet" href="./styles/mb-member-order-detail.css">
                            ...
                            <div class="order-detail-info">
                                ...
                                <div class="detail-price">
                                    <div class="price-left">
                                        ...
                                        <div><p>運費</p></div>
                                        <div><p>優惠折抵</p></div>
                                        <div class="order-total-price"><p>總計</p></div>
                                    </div>
                                    <div class="price-right">
                                        <div><p>NT.30</p></div>
                                        <div><p>NT.60</p></div>
                                        <div><p>-NT.60</p></div>
                                        <div class="order-total-price"><p>NT.2030</p></div>
                                    </div>
                                </div>
                                ...
                                <div class="buy-again">
                                        <button><p>再買一次</p><svg width="18" height="18" viewBox="0 0 26 23" fill="none" xmlns="http://www.w3.org/2000/svg">
